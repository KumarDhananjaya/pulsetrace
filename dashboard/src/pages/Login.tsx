            ...
            <div className="w-full max-w-md">
                <div className="bg-slate-900/50 border border-white/5 rounded-[2.5rem] p-10 shadow-2xl relative overflow-hidden backdrop-blur-xl">
                    ...
                    <div className="text-center mb-10">
                        ...
                        <p className="text-slate-500 text-sm">Sign in to your PulseTrace dashboard</p>
                    </div>
                    ...
                    <div className="relative mb-8 text-center">
                        ...
                        <span className="relative px-4 bg-[#0F111A] text-[10px] uppercase font-bold tracking-[0.2em] text-slate-600">Or continue with email</span>
                    </div>
                    ...
                    <div className="text-center mt-10 space-y-4">
                        <p className="text-xs text-slate-500">
                            Don't have an account? <Link to="/register" className="text-indigo-400 font-bold hover:text-indigo-300 transition-colors">Sign up for free</Link>
                        </p>
                        <div className="p-4 rounded-xl bg-indigo-500/5 border border-indigo-500/10">
                            <p className="text-[10px] text-slate-500 font-medium">
                                Demo: <code className="text-indigo-400">demo@pulsetrace.com</code> / <code className="text-indigo-400">password123</code>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <p className="mt-12 text-center text-[10px] text-slate-600 uppercase tracking-widest leading-loose">
                    By signing in, you agree to our <a href="#" className="underline hover:text-slate-400">Terms of Service</a><br />and <a href="#" className="underline hover:text-slate-400">Privacy Policy</a>.
                </p>
            </div>
        </div>
    );
